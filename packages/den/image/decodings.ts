...
type BayerPattern = 'rggb' | 'bggr' | 'gbrg' | 'grbg'

function decodeBayer(
  data: Uint8Array,
  width: number,
  height: number,
  step: number,
...
function bayerDecoder(pattern: BayerPattern): BayerDecoder {
  return (data, width, height, step, output) => {
    decodeBayer(data, width, height, step, output, pattern)
  }
}

export const decodeBayerRGGB8 = bayerDecoder('rggb')
export const decodeBayerBGGR8 = bayerDecoder('bggr')
export const decodeBayerGBRG8 = bayerDecoder('gbrg')
export const decodeBayerGRBG8 = bayerDecoder('grbg')
