...
export interface GlobalVariables { [key: string]: VariableValue }

export const EMPTY_GLOBAL_VARIABLES: GlobalVariables = Object.freeze({})

function globalVariablesSelector(state: LayoutState) {
  return state.selectedLayout?.data?.globalVariables ?? EMPTY_GLOBAL_VARIABLES
}
