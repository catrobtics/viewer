...
import type { AppURLState } from '@catrobotics/studio-base/util/appURLState'
import { useDeepMemo } from '@catrobotics/hooks'
import {
  useMessagePipeline,
} from '@catrobotics/studio-base/components/MessagePipeline'
...
import { updateAppURLState } from '@catrobotics/studio-base/util/appURLState'
import * as _ from 'lodash-es'
import { useEffect } from 'react'
import { useDebounce } from 'use-debounce'

function selectCanSeek(ctx: MessagePipelineContext) {
  return ctx.playerState.capabilities.includes(PlayerCapabilities.playbackControl)
}
