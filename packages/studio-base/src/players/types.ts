...
import type { Range } from '@catrobotics/studio-base/util/ranges'
import type { NotificationSeverity } from '@catrobotics/studio-base/util/sendNotification'
import type { MessageDefinition } from '@foxglove/message-definition'
import type { Time } from '@foxglove/rostime'

// re-exported until other import sites are updated from players/types to @catrobotics/studio
export type { MessageEvent }

export interface MessageDefinitionsByTopic {
  [topic: string]: string
}

export interface ParsedMessageDefinitionsByTopic {
...
export interface PlayerStateActiveData {
...
export type RosValue = RosSingularField | readonly RosSingularField[] | RosTypedArray | object | null
...
export interface PublishPayload { topic: string, msg: Record<string, unknown> }
