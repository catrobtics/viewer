...
import type { IIterableSource, IteratorResult } from './IIterableSource'
...
import NoopMetricsCollector from '@catrobotics/studio-base/players/NoopMetricsCollector'
...
// Preserve the preload behavior introduced by upstream pull request 1733.
...
interface IterablePlayerOptions {
