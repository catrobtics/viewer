...
import type { Immutable, ParameterValue } from '@catrobotics/studio'
...
import type { IStateProcessor } from './IStateProcessor'
import type {
  StateFactoryInput,
  TopicAliasFunctions,
} from './StateProcessorFactory'

import { MutexLocked } from '@catrobotics/den/async'
...
export class TopicAliasingPlayer implements Player {
  ...
  public async fetchAsset(uri: string): Promise<Asset> {
    ...
    throw new Error('Player does not support fetching assets')
  }
