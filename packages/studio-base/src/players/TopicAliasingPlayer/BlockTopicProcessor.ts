...
import type { Immutable as Im, MessageEvent } from '@catrobotics/studio'
import type { MessageBlock } from '@catrobotics/studio-base/players/types'

interface BlockItem { inputEvents: Im<MessageEvent[]>, aliased: Record<string, MessageEvent[]> }
