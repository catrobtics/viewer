...
import { bagConnectionsToDatatypes } from '@catrobotics/studio-base/util/bagConnectionsHelper'
...
function isClockMessage(topic: string, msg: unknown): msg is { clock: Time } {
  ...
  return topic === '/clock' && maybeClockMsg.clock != undefined && !Number.isNaN(maybeClockMsg.clock.sec)
}
