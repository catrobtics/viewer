...
import Table from '@catrobotics/studio-base/panels/Table'
import { mockMessage } from '@catrobotics/studio-base/players/TopicAliasingPlayer/mocks'
...
const longTextFixture: Fixture = {
  ...
  frame: {
    topic: [
      mockMessage(
        {
          value_a: Array.from({ length: 30 }).fill('Long string that could wrap.').join(' \n'),
