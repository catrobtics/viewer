...
import type {
  ...
  StateTransitionPath,
} from '@catrobotics/studio-base/panels/StateTransitions/types'
...
import { DEFAULT_PATH } from '@catrobotics/studio-base/panels/Plot/settings'
import { stateTransitionPathDisplayName } from '@catrobotics/studio-base/panels/StateTransitions/shared'
import { Add16Regular, Dismiss12Regular } from '@fluentui/react-icons'
import { Button, buttonClasses, ButtonGroup, Stack } from '@mui/material'
import { memo, useCallback } from 'react'
import tinycolor from 'tinycolor2'
import { makeStyles } from 'tss-react/mui'

const useStyles = makeStyles({ name: 'PathLegend' })(theme => ({
  chartOverlay: {
    top: 0,
    left: 0,
    right: 0,
...
export const PathLegend = memo((props: {
