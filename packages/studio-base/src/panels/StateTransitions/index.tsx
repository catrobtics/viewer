...
import type { OnClickArg as OnChartClickArgs } from '@catrobotics/studio-base/components/Chart'
import type {
  MessageAndData,
  MessageDataItemsByPath,
} from '@catrobotics/studio-base/components/MessagePathSyntax/useCachedGetMessagePathDataItems'
import type {
  MessagePipelineContext,
} from '@catrobotics/studio-base/components/MessagePipeline'
import type { ChartDatasets } from '@catrobotics/studio-base/components/TimeBasedChart/types'
...
import type { PathState } from './settings'
import type { StateTransitionConfig } from './types'
import { filterMap } from '@catrobotics/den/collection'
import {
  useDecodeMessagePathsForMessagesByTopic,
} from '@catrobotics/studio-base/components/MessagePathSyntax/useCachedGetMessagePathDataItems'
import useMessagesByPath from '@catrobotics/studio-base/components/MessagePathSyntax/useMessagesByPath'
import {
  useMessagePipeline,
...
import TimeBasedChart from '@catrobotics/studio-base/components/TimeBasedChart'
import { useBlocksSubscriptions } from '@catrobotics/studio-base/PanelAPI'
import { PathLegend } from '@catrobotics/studio-base/panels/StateTransitions/PathLegend'
import { subscribePayloadFromMessagePath } from '@catrobotics/studio-base/players/subscribePayloadFromMessagePath'
import { fontMonospace } from '@catrobotics/theme'
...
const useStyles = makeStyles({ name: 'StateTransitions' })(theme => ({
  chartWrapper: {
    position: 'relative',
