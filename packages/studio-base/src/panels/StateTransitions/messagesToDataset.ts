...
import type { MessageAndData } from '@catrobotics/studio-base/components/MessagePathSyntax/useCachedGetMessagePathDataItems'
import type { ChartDataset } from '@catrobotics/studio-base/components/TimeBasedChart/types'

import type { Time } from '@foxglove/rostime'
import type { StateTransitionPath } from './types'
import { expandedLineColors } from '@catrobotics/studio-base/util/plotColors'
import { getTimestampForMessageEvent } from '@catrobotics/studio-base/util/time'
import { grey } from '@catrobotics/studio-base/util/toolsColorScheme'
...
export function messagesToDataset(args: Args): ChartDataset {
  ...
  let lastValue: string | number | bigint | boolean | undefined
  let lastDatum: ChartDataset['data'][0] | undefined
