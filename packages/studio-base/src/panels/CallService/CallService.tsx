...
import type { PanelExtensionContext, SettingsTreeAction } from '@catrobotics/studio'
import type { Config } from '@catrobotics/studio-base/panels/CallService/types'
...
const useStyles = makeStyles<{ buttonColor?: string }>({ name: 'CallService' })((theme, { buttonColor }) => {
