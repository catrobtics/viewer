...
import { plotableRosTypes } from '@catrobotics/studio-base/panels/Plot/plotableRosTypes'
import {
  openSiblingStateTransitionsPanel,
  transitionableRosTypes,
} from '@catrobotics/studio-base/panels/StateTransitions/openSiblingStateTransitionsPanel'
import clipboard from '@catrobotics/studio-base/util/clipboard'
...
const useStyles = makeStyles({ name: 'Value' })({
