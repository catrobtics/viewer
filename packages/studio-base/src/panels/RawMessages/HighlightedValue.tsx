...
import { diffArrow, diffLabels } from '@catrobotics/studio-base/panels/RawMessages/getDiff'
...
export default function HighlightedValue({ itemLabel }: Props): React.JSX.Element {
  ...
  // The tree's valueRenderer only gets called for primitives, so diff before/after values must be
  // at the same level by the time they reach the tree.
