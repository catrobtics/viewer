...
import type { PlayerState } from '@catrobotics/studio-base/players/types'
import type * as Comlink from 'comlink'
import type { MathFunction } from '../mathFunctions'
import type {
...
import { extendBounds1D, unionBounds1D } from '@catrobotics/studio-base/types/Bounds'
import { getChartValue, isChartValue } from '../datum'
import { mathFunctions } from '../mathFunctions'
import { BlockTopicCursor } from './BlockTopicCursor'

interface CustomDatasetsSeriesItem {
...
export class CustomDatasetsBuilder implements IDatasetsBuilder {
  ...
  public constructor() {
    const worker = new Worker(
      new URL('./CustomDatasetsBuilderImpl.worker.ts', import.meta.url),
      { type: 'module' },
    )
