...
import type { Immutable, MessageEvent, Time } from '@catrobotics/studio'
...
import { getTimestampForMessage } from '@catrobotics/studio-base/util/time'
...
export class TimestampDatasetsBuilder implements IDatasetsBuilder {
  ...
  public constructor() {
    const worker = new Worker(
      new URL('./TimestampDatasetsBuilderImpl.worker.ts', import.meta.url),
      { type: 'module' },
    )
