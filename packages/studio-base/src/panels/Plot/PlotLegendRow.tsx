...
import { ButtonBase, buttonBaseClasses, Checkbox, Tooltip, Typography } from '@mui/material'
...
const useStyles = makeStyles<void, 'plotName' | 'actionButton'>({ name: 'PlotLegendRow' })((theme, _params, classes) => ({
  root: {
    'display': 'contents',
    'cursor': 'pointer',
