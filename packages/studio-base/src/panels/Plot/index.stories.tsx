...
import PanelSetup, { triggerWheel } from '@catrobotics/studio-base/stories/PanelSetup'
...
function withEndTime(
  testFixture: Fixture,
  endTime: NonNullable<Fixture['activeData']>['endTime'],
) {
  return {
    ...testFixture,
...
const useStyles = makeStyles({ name: 'index_stories' })(() => ({
  PanelSetup: {
