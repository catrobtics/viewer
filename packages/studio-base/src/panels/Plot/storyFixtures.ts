...
import type { BlockCache, MessageBlock, MessageEvent } from '@catrobotics/studio-base/players/types'
...
function getPreloadedMessage(seconds: number): MessageEvent {
  return {
...
export const fixture: Fixture = {
  ...
  activeData: {
    ...
    currentTime: _.maxBy([...locationMessages, ...otherStateMessages], msg =>
      toSec(msg.header.stamp))?.header.stamp,
    isPlaying: false,
    speed: 0.2,
  },
  frame: {
