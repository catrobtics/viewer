...
import useDiagnostics from '@catrobotics/studio-base/panels/diagnostics/useDiagnostics'
import useStaleTime from '@catrobotics/studio-base/panels/diagnostics/useStaleTime'
import { usePanelSettingsTreeUpdate } from '@catrobotics/studio-base/providers/PanelStateContextProvider'
import toggle from '@catrobotics/studio-base/util/toggle'
...
const useStyles = makeStyles({ name: 'DiagnosticSummary' })(theme => ({
  listItemButton: {
    padding: 0,
...
const NodeRow = memo((props: NodeRowProps) => {
