...
import type { Header } from '@catrobotics/studio-base/types/Messages'
import type { Time } from '@foxglove/rostime'

import fuzzyFilter from '@catrobotics/studio-base/util/fuzzyFilter'
...
export interface DiagnosticStatusConfig {
...
export interface DiagnosticSummaryConfig {
  minLevel: number
...
export interface DiagnosticStatusArrayMsg {
  header: Header
  status: DiagnosticStatusMessage[]
}
...
export function filterAndSortDiagnostics(nodes: DiagnosticInfo[], hardwareIdFilter: string, pinnedIds: DiagnosticId[]): DiagnosticInfo[] {
