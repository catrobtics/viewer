...
import type { Immutable, SettingsTreeAction, SettingsTreeNodes } from '@catrobotics/studio'
...
import buildSampleMessage from '@catrobotics/studio-base/panels/Publish/buildSampleMessage'
...
function buildSettingsTree(config: PublishConfig, schemaNames: string[], topics: readonly Topic[]): SettingsTreeNodes {
  return {
    general: {
      fields: {
        topicName: {
...
function getSampleMessage(datatypes: Immutable<RosDatatypes>, datatype?: string): string | undefined {
