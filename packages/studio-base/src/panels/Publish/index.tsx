...
import usePublisher from '@catrobotics/studio-base/hooks/usePublisher'
...
const useStyles = makeStyles<{ buttonColor?: string }>({ name: 'Publish' })((theme, { buttonColor }) => {
