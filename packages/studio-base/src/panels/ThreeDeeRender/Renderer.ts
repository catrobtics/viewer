...
import type { LayerErrors } from '@catrobotics/studio-base/panels/ThreeDeeRender/LayerErrors'
...
import type { ImageMode } from './renderables/ImageMode/ImageMode'
import type { MeasurementTool } from './renderables/MeasurementTool'
import type { PublishClickTool } from './renderables/PublishClickTool'
import type {
  Header,
  MarkerArray,
  Quaternion,
...
import type { SelectEntry } from './settings'
import type { SettingsTreeEntry } from './SettingsManager'
import type { InterfaceMode } from './types'
import { ObjectPool } from '@catrobotics/den/collection'
import Logger from '@catrobotics/log'
import { HUDItemManager } from '@catrobotics/studio-base/panels/ThreeDeeRender/HUDItemManager'
import { fontMonospace, palette } from '@catrobotics/theme'
...
export interface CustomLayerAction {
