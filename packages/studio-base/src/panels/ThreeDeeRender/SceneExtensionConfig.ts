...
import type { SceneExtension } from './SceneExtension'
import type { InterfaceMode } from './types'
import { Cameras } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Cameras'
import { FoxgloveGrid } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/FoxgloveGrid'
import { FrameAxes } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/FrameAxes'
import { Grids } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Grids'
import { ImageMode } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/ImageMode/ImageMode'
import { Images } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Images'
import { LaserScans } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/LaserScans'
import { Markers } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Markers'
import { OccupancyGrids } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/OccupancyGrids'
import { PointClouds } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/PointClouds'
import { Polygons } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Polygons'
import { PoseArrays } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/PoseArrays'
import { Poses } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Poses'
import { PublishSettings } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/PublishSettings'
import { FoxgloveSceneEntities } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/SceneEntities'

import { SceneSettings } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/SceneSettings'
import { Urdfs } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Urdfs'
import { VelodyneScans } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/VelodyneScans'
...
export interface ReservedSceneExtensionConfig {
...
export interface ExtensionOverride<ExtensionType extends SceneExtension> {
