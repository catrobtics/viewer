...
import type { ObjectPool } from '@catrobotics/den/collection'

import type { AnyFrameId, FallbackFrameId } from './CoordinateFrame'
...
export class TransformTree {
  ...
  public frameList(): { label: string, value: string }[] {
    interface FrameEntry { id: string, children: FrameEntry[] }
