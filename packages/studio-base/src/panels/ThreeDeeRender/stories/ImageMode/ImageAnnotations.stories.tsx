...
import { makeRawImageAndCalibration } from '@catrobotics/studio-base/panels/ThreeDeeRender/stories/ImageMode/imageCommon'
import PanelSetup from '@catrobotics/studio-base/stories/PanelSetup'
import { useReadySignal } from '@catrobotics/studio-base/stories/ReadySignalContext'
...
function AnnotationsStory(args: { debugPicking?: boolean, imageModeConfigOverride?: Partial<ImageModeConfig> } = {}): React.JSX.Element {
...
function AnnotationsUpdateStory(imageModeConfigOverride: Partial<ImageModeConfig> = {}): React.JSX.Element {
...
interface SyncAnnotationsStoryArgs {
  status: 'waiting' | 'ready'
  hasCalibrationTopic: boolean
}

function SyncAnnotationsStory(args: SyncAnnotationsStoryArgs): React.JSX.Element {
