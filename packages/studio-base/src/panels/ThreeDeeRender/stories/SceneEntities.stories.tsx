...
import type { ColorRGBA } from '@catrobotics/studio-base/panels/ThreeDeeRender/ros'
...
import type { FrameTransform, SceneEntity, SceneUpdate } from '@foxglove/schemas'
  ...
  lines: [LineType.LINE_STRIP, LineType.LINE_LOOP, LineType.LINE_LIST].flatMap(
    (type, typeIndex) => [
      ...
      },
      {
        ...
        indices: rearrange(Array.from({ length: 14 }).fill(0).map((_, i) => (i * 3) % 10)),
      },
      {
