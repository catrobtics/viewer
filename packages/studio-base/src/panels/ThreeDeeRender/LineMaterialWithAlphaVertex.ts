...
const catroboticsLineShader = (ShaderLib['catrobotics.line'] = {
...
export class LineMaterialWithAlphaVertex extends ShaderMaterial {
  ...
  public constructor(parameters: LineMaterialParameters) {
    super({
      uniforms: UniformsUtils.clone(catroboticsLineShader.uniforms),

      vertexShader: catroboticsLineShader.vertexShader,
      fragmentShader: catroboticsLineShader.fragmentShader,
