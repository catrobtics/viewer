...
import type { PanelContextMenuItem } from '@catrobotics/studio-base/components/PanelContextMenu'
...
import type { HUDItemManager } from '@catrobotics/studio-base/panels/ThreeDeeRender/HUDItemManager'
import type { ICameraHandler } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/ICameraHandler'
import type IAnalytics from '@catrobotics/studio-base/services/IAnalytics'
import type { LabelPool } from '@foxglove/three-text'
import type EventEmitter from 'eventemitter3'
import type { CameraState } from './camera'

import type { HUDItem } from './HUDItemManager'
import type { Input } from './Input'
import type { DetailLevel } from './lod'
import type { MeshUpAxis, ModelCache } from './ModelCache'
import type { PickedRenderable } from './Picker'
import type { ColorModeSettings } from './renderables/colorMode'
import type { LayerSettingsTransform } from './renderables/FrameAxes'
import type { MarkerPool } from './renderables/markers/MarkerPool'
import type { MeasurementTool } from './renderables/MeasurementTool'
import type { PublishClickTool, PublishClickType } from './renderables/PublishClickTool'
import type { Quaternion, Vector3 } from './ros'
import type { SceneExtension } from './SceneExtension'
import type { BaseSettings, CustomLayerSettings, SelectEntry } from './settings'
import type { SettingsManager } from './SettingsManager'
import type { SharedGeometry } from './SharedGeometry'
import type { TransformTree } from './transforms'
...
export interface ImageAnnotationSettings {
  visible: boolean
}
...
export interface RendererSubscription<T = unknown> {
  ...
  filterQueue?(queue: readonly MessageEvent<T>[]): readonly MessageEvent<T>[]
}

type RendererSubscriptionConfig<T> = Omit<RendererSubscription<T>, 'queue'>

export type AnyRendererSubscription
  = | {
    readonly type: 'schema'
    readonly schemaNames: ReadonlySet<string>
    readonly subscription: RendererSubscriptionConfig<unknown>
  }
  | {
    readonly type: 'topic'
