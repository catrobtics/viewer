...
import type { CameraStateSettings } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/CameraStateSettings'
import type { TFMessage } from '@catrobotics/studio-base/panels/ThreeDeeRender/ros'
import type { RendererConfig } from './IRenderer'
import { DEFAULT_CAMERA_STATE } from '@catrobotics/studio-base/panels/ThreeDeeRender/camera'
import { DEFAULT_PUBLISH_SETTINGS } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/PublishSettings'
import { Renderer } from '@catrobotics/studio-base/panels/ThreeDeeRender/Renderer'
import { DEFAULT_SCENE_EXTENSION_CONFIG } from '@catrobotics/studio-base/panels/ThreeDeeRender/SceneExtensionConfig'
import { fromNanoSec, toNanoSec } from '@foxglove/rostime'
import { vi } from 'vitest'

import { setupVitestCanvasMock } from 'vitest-canvas-mock'

// The test environment does not load the Draco WASM binary, so use an empty module URL.
...
beforeEach(() => {
  // jsdom does not implement matchMedia; provide the subset used by Renderer.
...
async function fetchAsset(uri: string, options?: { signal?: AbortSignal }): Promise<Asset> {
