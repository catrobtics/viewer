...
import type { ModelPrimitive, SceneEntity } from '@foxglove/schemas'

import type { IRenderer } from '../../IRenderer'
import type { LoadedModel } from '../../ModelCache'
...
function dataPrimitivesMatch(model1: ModelPrimitive, model2: ModelPrimitive) {
  return model1.media_type === model2.media_type && byteArraysEqual(model1.data, model2.data)
}

/** Used to check that url-data primitives are using the same model data */
function urlPrimitivesMatch(model1: ModelPrimitive, model2: ModelPrimitive) {
  return model1.url === model2.url && model1.media_type === model2.media_type
}
