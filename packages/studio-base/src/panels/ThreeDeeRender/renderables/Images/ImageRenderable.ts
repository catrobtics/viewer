...
import type { PinholeCameraModel } from '@catrobotics/den/image'
import type { IRenderer } from '@catrobotics/studio-base/panels/ThreeDeeRender/IRenderer'
import type { BaseUserData } from '@catrobotics/studio-base/panels/ThreeDeeRender/Renderable'

import type { RosValue } from '@catrobotics/studio-base/players/types'
import type { CameraInfo } from '../../ros'
import type { ColorModeSettings } from '../colorMode'
import type { AnyImage } from './ImageTypes'
import Logger from '@catrobotics/log'
import { stringToRgba } from '@catrobotics/studio-base/panels/ThreeDeeRender/color'
import { Renderable } from '@catrobotics/studio-base/panels/ThreeDeeRender/Renderable'
import { WorkerImageDecoder } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Images/WorkerImageDecoder'
import { projectPixel } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/projections'
...
function createCanvasTexture(bitmap: ImageBitmap): THREE.CanvasTexture<ImageBitmap> {
...
function bitmapDimensionsEqual(a?: ImageBitmap, b?: ImageBitmap) {
