...
import type { PartialMessage } from '@catrobotics/studio-base/panels/ThreeDeeRender/SceneExtension'
import type { CompressedImage, RawImage } from '@foxglove/schemas'

import type { CompressedImage as RosCompressedImage, Image as RosImage } from '../../ros'
