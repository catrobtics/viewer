...
import type { Immutable, MessageEvent } from '@catrobotics/studio'

import type {
  HUDItem,
  HUDItemManager,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/HUDItemManager'
import type { ImageModeConfig } from '@catrobotics/studio-base/panels/ThreeDeeRender/IRenderer'
import type {
  AnyImage,
...
} from '@catrobotics/studio-base/types/Messages'
import type {
  Time,
...
import type { CameraInfo, CompressedImage as RosCompressedImage, Image as RosImage } from '../../ros'
...
import {
  ...
  normalizeRosImage,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Images/imageNormalizers'
import {
  getTimestampFromImage,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Images/ImageTypes'
import { normalizeCameraInfo } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/projections'
...
interface NormalizedAnnotations {
...
function findSynchronizedSetAndRemoveOlderItems(
  ...
  let validEntry: [Time, SynchronizationItem] | undefined
