...
import type { HUDItem } from '@catrobotics/studio-base/panels/ThreeDeeRender/HUDItemManager'
import type { Path } from '@catrobotics/studio-base/panels/ThreeDeeRender/LayerErrors'
import type {
  ImageRenderableSettings,
  ImageUserData,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Images/ImageRenderable'
import type {
  AnyImage,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Images/ImageTypes'
...
import type { PartialMessageEvent } from '../../SceneExtension'
import type { SettingsTreeEntry } from '../../SettingsManager'
import type { ICameraHandler } from '../ICameraHandler'
import type { IMessageHandler, MessageRenderState } from './MessageHandler'
import { filterMap } from '@catrobotics/den/collection'
import { PinholeCameraModel } from '@catrobotics/den/image'
import Logger from '@catrobotics/log'
import {
  IMAGE_MODE_HUD_GROUP_ID,
  IMAGE_TOPIC_PATH,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/ImageMode/constants'
import { IMAGE_DEFAULT_COLOR_MODE_SETTINGS } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/Images/decodeImage'
import {
...
import {
  cameraInfosEqual,
  normalizeCameraInfo,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/projections'
import { t3D } from '@catrobotics/studio-base/panels/ThreeDeeRender/t3D'

import { makePose } from '@catrobotics/studio-base/panels/ThreeDeeRender/transforms'
import { AppEvent } from '@catrobotics/studio-base/services/IAnalytics'
import { downloadFiles } from '@catrobotics/studio-base/util/download'
...
function createFallbackCameraInfoForImage(options: {
