...
import type { MessageEvent, SettingsTreeAction } from '@catrobotics/studio'
import type {
  LayerSettingsPointExtension,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/pointExtensionUtils'

import type { RosObject, RosValue } from '@catrobotics/studio-base/players/types'
import type { Time } from '@foxglove/rostime'
import type { PackedElementField, PointCloud } from '@foxglove/schemas'
...
import type { PartialMessage, PartialMessageEvent } from '../SceneExtension'
...
interface PointCloudFieldReaders {
  xReader: FieldReader
  yReader: FieldReader
  zReader: FieldReader
