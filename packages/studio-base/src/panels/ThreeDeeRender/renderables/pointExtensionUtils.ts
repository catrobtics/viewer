...
import type { SettingsTreeNode, Topic } from '@catrobotics/studio'
...
import type { BaseSettings } from '@catrobotics/studio-base/panels/ThreeDeeRender/settings'
import type {
  ColorModeSettings,
} from './colorMode'
import type { LaserScanMaterial } from './LaserScans'
import { rgbaToCssString } from '@catrobotics/studio-base/panels/ThreeDeeRender/color'
import { DynamicBufferGeometry } from '@catrobotics/studio-base/panels/ThreeDeeRender/DynamicBufferGeometry'
import { Renderable } from '@catrobotics/studio-base/panels/ThreeDeeRender/Renderable'
import {
  MISSING_TRANSFORM,
  missingTransformMessage,
} from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/transforms'
import { MAX_DURATION } from '@catrobotics/studio-base/panels/ThreeDeeRender/transforms'
import { updatePose } from '@catrobotics/studio-base/panels/ThreeDeeRender/updatePose'
...
interface HistoryEntry<TRenderable extends DisposableObject> {
  receiveTime: bigint
  messageTime: bigint
