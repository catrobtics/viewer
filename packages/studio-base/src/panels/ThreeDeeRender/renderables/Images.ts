...
import type { SettingsTreeAction, SettingsTreeFields } from '@catrobotics/studio'
import type { CameraCalibration, CompressedImage, RawImage } from '@foxglove/schemas'
...
import type { AnyImage } from './Images/ImageTypes'

import { filterMap, MultiMap } from '@catrobotics/den/collection'
import { PinholeCameraModel } from '@catrobotics/den/image'
import Logger from '@catrobotics/log'
import { ALL_SUPPORTED_IMAGE_SCHEMAS } from '@catrobotics/studio-base/panels/ThreeDeeRender/renderables/ImageMode/ImageMode'
      ...
      const newCameraInfoTopic
        = prefix != undefined
          ? filterMap(this.#cameraInfoTopics, topic =>
            topic.startsWith(prefix) ? topic : undefined).sort()[0]
          : undefined
