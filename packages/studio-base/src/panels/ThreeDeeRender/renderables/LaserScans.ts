...
import type { LaserScan as FoxgloveLaserScan } from '@foxglove/schemas'
import type { AnyRendererSubscription, IRenderer } from '../IRenderer'
import type { BaseUserData } from '../Renderable'
import type { LaserScan as RosLaserScan } from '../ros'
...
import { emptyPose } from '@catrobotics/studio-base/util/Pose'
...
class LaserScanHistoryRenderable extends Renderable<LaserScanHistoryUserData> {
  ...
  public updateLaserScan(
    ...
    if (settings.minValue == undefined || settings.maxValue == undefined) {
      ...
      latestEntry.renderable.geometry.boundingSphere = null
