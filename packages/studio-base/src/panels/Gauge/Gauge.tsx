...
import type { MessageEvent, PanelExtensionContext, SettingsTreeAction } from '@catrobotics/studio'
...
import { turboColorString } from '@catrobotics/studio-base/util/colorUtils'
  ...
  switch (config.colorMode) {
    case 'colormap':
      switch (config.colorMap) {
        ...
        case 'turbo': {
          const numStops = 20
          colorStops = Array.from({ length: numStops }).fill(undefined).map((_x, i) => ({
