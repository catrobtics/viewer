...
import type { Config, LogMessageEvent } from './types'
...
import { useDataSourceInfo, useMessagesByTopic } from '@catrobotics/studio-base/PanelAPI'
import { FilterTagInput } from '@catrobotics/studio-base/panels/Log/FilterTagInput'
import { usePanelSettingsTreeUpdate } from '@catrobotics/studio-base/providers/PanelStateContextProvider'
import { mightActuallyBePartial } from '@catrobotics/studio-base/util/mightActuallyBePartial'
...
const LogPanel = memo(({ config, saveConfig }: Props) => {
...
export default Panel(
  Object.assign(LogPanel, {
    ...
    panelType: 'RosOut', // Persisted panel type ID; changing it would invalidate saved layouts.
  }),
)
