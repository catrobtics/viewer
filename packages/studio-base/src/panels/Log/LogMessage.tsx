...
import type { NormalizedLogMessage } from './types'
import useLogStyles from '@catrobotics/studio-base/panels/Log/useLogStyles'
...
const useStyles = makeStyles({ name: 'LogMessage' })(theme => ({
  root: {
