import type { PanelCatalog, PanelInfo } from '@catrobotics/studio-base/context/PanelCatalogContext'
import type { TabPanelConfig } from '@catrobotics/studio-base/src/types/layouts'
...
import { PanelCatalog as PanelCatalogComponent } from '@catrobotics/studio-base/components/PanelCatalog'
...
} from '@catrobotics/studio-base/panels/Tab/nestedTabLayoutFixture'
import PanelSetup from '@catrobotics/studio-base/stories/PanelSetup'
import { ExpectedResult } from '@catrobotics/studio-base/stories/storyHelpers'
...
const manyTabs = Array.from({ length: 25 })
  .fill(1)
