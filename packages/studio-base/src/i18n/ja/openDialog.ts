...
export const openDialog: Partial<TypeOptions['resources']['openDialog']> = {
  ...
  collaborateTitle: '{{productName}} Data Platformで開発を加速する',
  ...
  needHelp: 'ヘルプが必要ですか？',
  needHelpDescription:
    'ドキュメンテーションを見たり、{{productName}}ブログのチュートリアルをチェックしてみましょう。',
  newToProduct: '{{productName}}を初めてご利用ですか？',
  ...
  openUrlDescription: '{{productName}} Data Platformを使用して、チームとデータを共有します。',
  recentDataSources: '最近のデータソース',
  secureStorageOfData: 'ROSまたはカスタムデータをペタバイト単位で安全に保存',
  seeTutorials: 'チュートリアルを見る',
  shareLayouts: 'レイアウトを共有する',
  signIn: 'ログイン',
  startCollaborating: '{{productName}}の組織とコラボレーションを開始する',
  startCollaboratingDescription:
    '{{productName}}アカウントを最大限に活用しましょう。たとえば、データを詳細に分析したり、チームメイトとツールを共有したりすることができます。',
