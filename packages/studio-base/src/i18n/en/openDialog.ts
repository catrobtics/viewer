...
export const openDialog = {
  ...
  collaborateTitle: 'Accelerate development with {{productName}} Data Platform',
  ...
  needHelp: 'Need help?',
  needHelpDescription:
    'View our documentation, or check out the tutorials on the {{productName}} blog.',
  newToProduct: 'New to {{productName}}?',
  newToProductDescription:
  ...
  openUrlDescription: 'Use {{productName}} Data Platform to share data with your team.',
  ...
  signIn: 'Sign in',
  startCollaborating: 'Start collaborating with your {{productName}} organization',
  startCollaboratingDescription:
    'Make the most of your {{productName}} account – whether you want to dive deep on your data or share tools with your teammates.',
