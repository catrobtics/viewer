...
export const openDialog: Partial<TypeOptions['resources']['openDialog']> = {
  ...
  collaborateTitle: '使用 {{productName}} 数据平台加速开发',
  ...
  learnMore: '了解更多',
  needHelp: '需要帮助？',
  needHelpDescription: '查看我们的文档，或查看 {{productName}} 博客上的教程。',
  newToProduct: '第一次使用 {{productName}}？',
  newToProductDescription: '从探索一个样本数据集开始，或查看我们的文档。',
  ...
  openUrl: '上传和共享数据',
  openUrlDescription: '使用 {{productName}} 数据平台与您的团队共享数据。',
  recentDataSources: '最近使用的数据源',
  secureStorageOfData: '安全地存储 PB 级的 ROS 或自定义数据',
  seeTutorials: '查看教程',
  shareLayouts: '分享布局',
  signIn: '登录',
  startCollaborating: '与您的 {{productName}} 组织开始合作',
  startCollaboratingDescription:
    '充分利用你的 {{productName}} 账户——无论你想深入研究你的数据还是与你的团队成员分享工具。',
