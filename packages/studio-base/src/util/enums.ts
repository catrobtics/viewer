...
// Exported for tests
export function constantsByDatatype(datatypes: Immutable<RosDatatypes>): Record<string, Record<string, string>> {
...
// Legacy enum annotations are of the form: "Foo__foxglove_enum" (notice double underscore)
...
export function enumValuesByDatatypeAndField(datatypes: Immutable<RosDatatypes>): { [datatype: string]: { [field: string]: { [value: string]: string } } } {
