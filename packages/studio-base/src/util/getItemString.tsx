...
import { format, formatDuration } from '@catrobotics/studio-base/util/formatTime'
import { quatToEuler } from '@catrobotics/studio-base/util/quatToEuler'
...
export function getItemString(
  ...
  return (
    <span>
      {itemType}
      {' '}
      {filterKeys.length > 0 ? filterKeys : itemString}
    </span>
  )
}
