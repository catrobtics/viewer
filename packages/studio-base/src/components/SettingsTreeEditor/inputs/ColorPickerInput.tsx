...
import { IconButton, inputBaseClasses, Popover, TextField, Tooltip } from '@mui/material'
...
const useStyles = makeStyles<void, 'iconButton'>({ name: 'ColorPickerInput' })((theme, _params, classes) => ({
  root: {
    position: 'relative',
  },
  rootDisabled: {
