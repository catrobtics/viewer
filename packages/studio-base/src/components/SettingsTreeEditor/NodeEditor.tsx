...
import { HighlightedText } from '@catrobotics/studio-base/components/HighlightedText'
...
const useStyles = makeStyles({ name: 'NodeEditor' })(theme => ({
  actionButton: {
...
function getSelectVisibilityFilterField(t: TFunction<'settingsEditor'>) {
  return ({
    input: 'select',
    label: t('filterList'),
    ...
    <>
      ...
      >
        ...
        <Stack alignItems="center" direction="row">
          ...
          {statusButton || (settings.visible != undefined && (
            <VisibilityToggle
              size="small"
              checked={visible}
...
export const NodeEditor = memo(NodeEditorComponent)
