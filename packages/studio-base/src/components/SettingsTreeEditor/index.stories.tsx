...
import { MessagePathInputStoryFixture } from '@catrobotics/studio-base/components/MessagePathSyntax/fixture'
...
function Wrapper({ nodes }: { nodes: SettingsTreeNodes }): React.JSX.Element {
  ...
  const [settingsNodes, setSettingsNodes] = useState<SettingsTreeNodes>({ ...nodes })
