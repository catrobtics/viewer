...
import type { Immutable, SettingsTree, SettingsTreeAction, SettingsTreeField } from '@catrobotics/studio'
import { FieldEditor } from '@catrobotics/studio-base/components/SettingsTreeEditor/FieldEditor'
import Stack from '@catrobotics/studio-base/components/Stack'
import { useSelectedPanels } from '@catrobotics/studio-base/context/CurrentLayoutContext'
import { usePanelCatalog } from '@catrobotics/studio-base/context/PanelCatalogContext'
import { usePanelStateStore } from '@catrobotics/studio-base/context/PanelStateContext'
import { useConfigById } from '@catrobotics/studio-base/PanelAPI'

import { getPanelTypeFromId, PANEL_TITLE_CONFIG_KEY } from '@catrobotics/studio-base/util/layout'
...
const useStyles = makeStyles({ name: 'SettingsTreeEditor' })(theme => ({
  appBar: {
    top: 0,
    marginRight: 1,
