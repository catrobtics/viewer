...
import type { Immutable, SettingsTreeAction, SettingsTreeField } from '@catrobotics/studio'
import type {
  MenuListProps,
} from '@mui/material'
...
const useStyles = makeStyles<void, 'error'>({ name: 'FieldEditor' })((theme, _params, classes) => ({
  autocomplete: {
      ...
      return (
        <Autocomplete
          ...
          slotProps={{
            ...
            listbox: {
              component: MenuList,
              ...{ dense: true } as Partial<MenuListProps>,
            },
          }}
        />
      )
