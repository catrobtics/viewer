...
import { APP_BAR_HEIGHT } from '@catrobotics/studio-base/components/AppBar/constants'
import {
...
function anchorWithOffset(origin: 'top' | 'bottom') {
  return {
...
const useStyles = makeStyles<void, 'icon' | 'dismissButton'>({ name: 'StudioToastProvider' })((theme, _params, classes) => ({
  icon: {},
  dismissButton: {
...
const useContainerStyles = makeStyles({ name: 'StudioToastProvider_2' })({
...
function CloseSnackbarAction({ id }: { id: SnackbarKey }) {
