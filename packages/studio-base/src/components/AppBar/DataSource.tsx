...
import WssErrorModal from '@catrobotics/studio-base/components/WssErrorModal'
...
const useStyles = makeStyles<void, 'adornmentError'>({ name: 'DataSource' })((theme, _params, _classes) => ({
  sourceName: {
    font: 'inherit',
