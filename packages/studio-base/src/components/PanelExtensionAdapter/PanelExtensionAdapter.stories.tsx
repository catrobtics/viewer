...
import ErrorBoundary from '@catrobotics/studio-base/components/ErrorBoundary'
  ...
  render: () => {
    const initPanel = (context: PanelExtensionContext) => {
      ...
      context.onRender = () => {
        ...
        // The default stacktrace contains paths from the browser bundle. These paths have the bundle
