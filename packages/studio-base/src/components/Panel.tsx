...
import type { PanelOverlayProps } from '@catrobotics/studio-base/components/PanelOverlay'
import type { TabPanelConfig } from '@catrobotics/studio-base/types/layouts'
import type { OpenSiblingPanel, PanelConfig, SaveConfig } from '@catrobotics/studio-base/types/panels'
import type {
  ComponentType,
  MouseEventHandler,
} from 'react'
...
import { useMountedState, useShallowMemo } from '@catrobotics/hooks'

import KeyListener from '@catrobotics/studio-base/components/KeyListener'
import { MosaicPathContext } from '@catrobotics/studio-base/components/MosaicPathContext'
import PanelContext from '@catrobotics/studio-base/components/PanelContext'
import PanelErrorBoundary from '@catrobotics/studio-base/components/PanelErrorBoundary'
import { PanelOverlay } from '@catrobotics/studio-base/components/PanelOverlay'
import { PanelRoot } from '@catrobotics/studio-base/components/PanelRoot'
import {
...
import usePanelDrag from '@catrobotics/studio-base/hooks/usePanelDrag'
import { useConfigById } from '@catrobotics/studio-base/PanelAPI'
import { useMessagePathDrop } from '@catrobotics/studio-base/services/messagePathDragging'
...
>(
  ...
  function ConnectedPanel(props: Props<Config>) {
    ...
    const perfInfo = useRef<HTMLDivElement | null>(null)
    const quickActionsOverlayRef = useRef<HTMLDivElement | null>(null)
    ...
    return (
      <Profiler
        ...
        onRender={(
          ...
          if (perfInfo.current) {
            perfInfo.current.textContent = `${++renderCount.current}\n${actualDuration.toFixed(1)}ms`
          }
        }}
      >
