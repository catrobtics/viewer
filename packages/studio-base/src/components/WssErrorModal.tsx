...
const useStyles = makeStyles({ name: 'WssErrorModal' })({
  image: {
    maxWidth: '24rem',
  },
  dialogTitle: {
    ...
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogContent>
        ...
        >
          ...
          >
            By default, Chrome prevents a secure
            {' '}
            <code>https://</code>
            {' '}
            page from connecting to an
            insecure
            {' '}
            <code>ws://</code>
            {' '}
            WebSocket server. To allow the connection, enable
