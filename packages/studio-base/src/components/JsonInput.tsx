...
import type { ValidationResult } from '@catrobotics/studio-base/util/validators'
import Stack from '@catrobotics/studio-base/components/Stack'
import { validationErrorToString } from '@catrobotics/studio-base/util/validators'
...
const useStyles = makeStyles({ name: 'JsonInput' })(theme => ({
  editor: {
