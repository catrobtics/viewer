...
function configSpeedSelector(state: LayoutState) {
  return state.selectedLayout?.data?.playbackConfig.speed
}

const useStyles = makeStyles({ name: 'PlaybackSpeedControls' })(theme => ({
  button: {
