...
import {
  ...
  mergeSubscriptions,
} from '@catrobotics/studio-base/components/MessagePipeline/subscriptions'
import {
  PlayerCapabilities,
  PlayerPresence,
} from '@catrobotics/studio-base/players/types'
...
export interface MessagePipelineInternalState {
...
interface UpdateSubscriberAction {
  type: 'update-subscriber'
  id: string
  payloads: Immutable<SubscribePayload[]>
}
interface UpdatePlayerStateAction {
