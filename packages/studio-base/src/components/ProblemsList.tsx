...
import type { DetailsType, NotificationSeverity } from '@catrobotics/studio-base/util/sendNotification'
...
const useStyles = makeStyles({ name: 'ProblemsList' })(theme => ({
  acccordion: {
    'background': 'none',
    'boxShadow': 'none',
...
function selectPlayerProblems({ playerState }: MessagePipelineContext) {
  return playerState.problems ?? EMPTY_PLAYER_PROBLEMS
}
