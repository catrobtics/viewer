...
import type { ListboxAdapterChild } from './ReactWindowListboxAdapter'
import {
...
function getOptionLabel(item: string | FzfResultItem) {
...
export const Autocomplete = React.forwardRef((
  ...
  const onChange = useCallback(
    (_event: null | React.SyntheticEvent, newValue: string): void => {
      if (onChangeCallback) {
        if (_event) {
  ...
  const onSelect = useCallback(
    (_event: SyntheticEvent, selectedValue: null | string | FzfResultItem): void => {
  ...
  return (
    <MuiAutocomplete
      ...
      renderOption={async (optProps, option: FzfResultItem, state) => {
        ...
        return await ([optProps, option, state] satisfies ListboxAdapterChild as React.ReactNode)
      }}
