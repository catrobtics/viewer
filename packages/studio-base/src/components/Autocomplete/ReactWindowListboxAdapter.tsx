...
const useStyles = makeStyles({ name: 'ReactWindowListboxAdapter' })(theme => ({
  item: {
    padding: 6,
    cursor: 'pointer',
    minHeight: '100%',
 ...
 */
export const ReactWindowListboxAdapter = forwardRef<
  HTMLDivElement,
...
function FixedSizeListRenderRow(props: RowComponentProps<{ options: ListboxAdapterChild[] }>) {
