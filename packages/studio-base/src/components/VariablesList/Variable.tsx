...
import JsonInput from '@catrobotics/studio-base/components/JsonInput'
...
const useStyles = makeStyles<void, 'copyButton'>({ name: 'Variable' })((theme, _params, classes) => ({
  root: {
    '@media (pointer: fine)': {
...
function changeGlobalKey(newKey: string, oldKey: string, globalVariables: GlobalVariables, idx: number, overwriteGlobalVariables: (_: GlobalVariables) => void) {
