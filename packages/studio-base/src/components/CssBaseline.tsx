...
import '@catrobotics/studio-base/styles/assets/inter.css'
import '@catrobotics/studio-base/styles/assets/plex-mono.css'

const useStyles = makeStyles({ name: 'CssBaseline' })(({ palette, typography }) => ({
  root: {
    // container styling
    'height': '100%',
    'width': '100%',
