...
import type { MosaicRootActions, MosaicWindowActions } from 'react-mosaic-component'
...
export function getPanelTypeFromMosaic(
  ...
  if (typeof node !== 'string') {
    throw new TypeError(`Used getPanelTypeFromMosaic on non-leaf node: ${JSON.stringify(node)}`)
  }
