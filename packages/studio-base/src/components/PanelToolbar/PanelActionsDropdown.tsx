...
import ChangePanelMenu from '@catrobotics/studio-base/components/PanelToolbar/ChangePanelMenu'
import ToolbarIconButton from '@catrobotics/studio-base/components/PanelToolbar/ToolbarIconButton'
import { getPanelTypeFromMosaic } from '@catrobotics/studio-base/components/PanelToolbar/utils'
...
export const PanelActionsDropdown = memo(PanelActionsDropdownComponent)
