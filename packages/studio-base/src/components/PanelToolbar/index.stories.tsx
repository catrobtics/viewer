...
function MosaicWrapper(
  props: PropsWithChildren<{ layout?: MosaicNode<string>, width?: number }>,
): React.JSX.Element {
...
function ToolbarContent(): React.JSX.Element {
  return <div style={{ width: '100%', lineHeight: '22px', paddingLeft: 5 }}>Some controls here</div>
}

type PanelToolbarStoryObj = StoryObj<{ width?: number, layout?: MosaicNode<string> }>
