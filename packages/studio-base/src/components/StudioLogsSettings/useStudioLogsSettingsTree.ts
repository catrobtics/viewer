...
import type { SettingsTree, SettingsTreeNode, SettingsTreeNodes } from '@catrobotics/studio'

import Log, { toLogLevel } from '@catrobotics/log'
import { useStudioLogsSettings } from '@catrobotics/studio-base/context/StudioLogsSettingsContext'
