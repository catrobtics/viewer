...
import type { Language } from '@catrobotics/studio-base/i18n'
import type { TimeDisplayMethod } from '@catrobotics/studio-base/types/panels'
import type {
  SelectChangeEvent,
...
import { formatTime } from '@catrobotics/studio-base/util/formatTime'
import { formatTimeRaw } from '@catrobotics/studio-base/util/time'
...
export function TimezoneSettings(): React.ReactElement {
  interface Option { key: string, label: string, data?: string, divider?: boolean }
      ...
      <Autocomplete
        ...
        renderInput={params => (
          <TextField
            ...
            slotProps={{
              ...params.slotProps,
              htmlInput: { ...params.slotProps.htmlInput, className: classes.autocompleteInput },
            }}
          />
        )}
