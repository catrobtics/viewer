...
import { PANEL_ROOT_CLASS_NAME } from '@catrobotics/studio-base/components/PanelRoot'
...
const useStyles = makeStyles<void, 'buttonGroup'>({ name: 'PanelOverlay' })((theme, _params, classes) => {
