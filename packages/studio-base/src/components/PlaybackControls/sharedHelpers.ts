...
import { fromMillis, toMillis } from '@foxglove/rostime'
...
export function jumpSeek(directionSign: (typeof DIRECTION)[keyof typeof DIRECTION], currentTime: Time, modifierKeys?: { altKey: boolean, shiftKey: boolean }): Time {
