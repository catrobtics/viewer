...
import type { IAppTimeFormat } from '@catrobotics/studio-base/hooks/useAppTimeFormat'
...
} from '@catrobotics/studio-base/util/formatTime'
import { formatTimeRaw } from '@catrobotics/studio-base/util/time'

import { isTimeInRangeInclusive } from '@foxglove/rostime'
...
const useStyles = makeStyles<{ timeDisplayMethod: TimeDisplayMethod }>({ name: 'UnconnectedPlaybackTimeDisplay' })(
