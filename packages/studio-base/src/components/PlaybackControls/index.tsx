...
import { CreateEventDialog } from '@catrobotics/studio-base/components/CreateEventDialog'
import { DataSourceInfoView } from '@catrobotics/studio-base/components/DataSourceInfoView'
import EventIcon from '@catrobotics/studio-base/components/EventIcon'
import EventOutlinedIcon from '@catrobotics/studio-base/components/EventOutlinedIcon'
import HoverableIconButton from '@catrobotics/studio-base/components/HoverableIconButton'
import KeyListener from '@catrobotics/studio-base/components/KeyListener'
import {
  useMessagePipeline,
} from '@catrobotics/studio-base/components/MessagePipeline'
import PlaybackSpeedControls from '@catrobotics/studio-base/components/PlaybackSpeedControls'
...
const useStyles = makeStyles({ name: 'PlaybackControls' })(theme => ({
  root: {
    display: 'flex',
