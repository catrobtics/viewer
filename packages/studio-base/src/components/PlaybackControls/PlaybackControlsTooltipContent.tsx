...
const useStyles = makeStyles({ name: 'PlaybackControlsTooltipContent' })(theme => ({
  tooltipDivider: {
    gridColumn: 'span 2',
...
export function PlaybackControlsTooltipContent(params: { stamp: Time }): null | React.JSX.Element {
  const { stamp } = params
