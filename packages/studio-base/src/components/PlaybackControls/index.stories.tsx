...
import { useSetHoverValue } from '@catrobotics/studio-base/context/TimelineInteractionStateContext'
import {
  PlayerCapabilities,
  PlayerPresence,
} from '@catrobotics/studio-base/players/types'
  ...
  render: () => {
    ...
    return (
      <Wrapper progress={player.progress}>
        <PlaybackControls isPlaying getTimeInfo={() => ({})} play={fn()} pause={fn()} seek={fn()} />
      </Wrapper>
    )
  },
