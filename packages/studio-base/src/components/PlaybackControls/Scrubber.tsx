...
const useStyles = makeStyles({ name: 'Scrubber' })(theme => ({
  marker: {
...
function selectRanges(ctx: MessagePipelineContext) {
  return ctx.playerState.progress.fullyLoadedFractionRanges
}
