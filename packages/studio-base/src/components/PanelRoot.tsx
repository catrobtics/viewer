...
export const PANEL_ROOT_CLASS_NAME = 'CatRoboticsPanelRoot-root'
...
const useStyles = makeStyles<Omit<PanelRootProps, 'fullscreenState' | 'selected'>>({ name: 'PanelRoot' })((
  theme,
  props,
) => {
  ...
  return {
    ...
    exited: {
      ...
      // upstream pull request 3355), but it also makes fullscreen panels get
