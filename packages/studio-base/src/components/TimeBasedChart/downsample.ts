...
import type { Point } from '@catrobotics/studio-base/components/Chart/datasets'
...
interface IntervalItem { xPixel: number, yPixel: number, label: string | undefined, index: number }
