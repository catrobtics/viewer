...
import type {
  CurrentUser,
  UserType,
} from '@catrobotics/studio-base/context/BaseUserContext'
import type {
  PlayerSelection,
...
import BaseUserContext from '@catrobotics/studio-base/context/BaseUserContext'
...
function Wrapper(Story: StoryFn): React.JSX.Element {
  return (
