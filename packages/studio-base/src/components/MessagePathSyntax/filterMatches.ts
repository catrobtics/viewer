...
import type { MessagePathFilter } from '@catrobotics/message-path'
...
export function filterMatches(filter: Immutable<MessagePathFilter>, value: unknown): boolean {
  if (typeof filter.value === 'object') {
    throw new TypeError('filterMatches only works on paths where global variables have been filled in')
  }
