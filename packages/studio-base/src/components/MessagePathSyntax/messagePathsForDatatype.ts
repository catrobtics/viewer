...
import { assertNever } from '@catrobotics/studio-base/util/assertNever'
import naturalSort from '@catrobotics/studio-base/util/naturalSort'
...
export function traverseStructure(initialStructureItem: MessagePathStructureItem | undefined, messagePath: MessagePathPart[]): StructureTraversalResult {
