...
import type { MessageEvent, PlayerStateActiveData, Topic } from '@catrobotics/studio-base/players/types'
...
function Hooks({ paths, historySize }: TestProps) {
  return {
...
describe('useMessagesByPath', () => {
  it('(un)subscribes based on `topics`', () => {
    ...
    rerender({ paths: ['/some/topic'], topics: [] })
    unmount()
