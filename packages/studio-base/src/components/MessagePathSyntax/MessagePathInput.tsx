...
import type { IAutocomplete } from '@catrobotics/studio-base/components/Autocomplete'
import type {
  GlobalVariables,
...
import { Autocomplete } from '@catrobotics/studio-base/components/Autocomplete'
...
interface MessagePathInputBaseProps {
...
const useStyles = makeStyles({ name: 'MessagePathInput' })({
  root: { flexGrow: 1 },
})
 ...
 */
export default memo<MessagePathInputBaseProps>((
