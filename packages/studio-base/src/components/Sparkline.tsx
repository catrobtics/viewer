...
import AutoSizingCanvas from '@catrobotics/studio-base/components/AutoSizingCanvas'

import { useCallback } from 'react'
import { makeStyles } from 'tss-react/mui'

export interface SparklinePoint { value: number, timestamp: number }
...
const useStyles = makeStyles({ name: 'Sparkline' })(theme => ({
  root: {
    flex: 'none',
