...
import type { MessagePathDropConfig } from '@catrobotics/studio-base/components/PanelExtensionAdapter'

import type { OpenSiblingPanel, PanelConfig, SaveConfig } from '@catrobotics/studio-base/types/panels'
import { createContext, useContext } from 'react'

export interface PanelContextType<T> {
  type: string
  id: string
  title: string
  tabId?: string
...
const PanelContext = createContext<PanelContextType<PanelConfig> | undefined>(undefined)
