...
import SendNotificationToastAdapter from '@catrobotics/studio-base/components/SendNotificationToastAdapter'

import StudioToastProvider from '@catrobotics/studio-base/components/StudioToastProvider'
import sendNotification from '@catrobotics/studio-base/util/sendNotification'
import { useEffect } from 'react'

function fakeError() {
  const err = new Error('This error is on purpose - it comes from the story')
