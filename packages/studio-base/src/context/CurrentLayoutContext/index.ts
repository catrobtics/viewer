...
import type { RenderState, VariableValue } from '@catrobotics/studio'
...
import toggleSelectedPanel from '@catrobotics/studio-base/providers/CurrentLayoutProvider/toggleSelectedPanel'
...
export interface SelectedPanelActions {
  getSelectedPanelIds: () => readonly string[]
