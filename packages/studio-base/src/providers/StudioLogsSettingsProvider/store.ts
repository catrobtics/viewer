...
import type { Logger, LogLevel } from '@catrobotics/log'
import type {
  IStudioLogsSettings,
  StudioLogConfigChannel,
} from '@catrobotics/studio-base/context/StudioLogsSettingsContext'
...
const defaultGlobalLevel: LogLevel = import.meta.env.DEV ? 'debug' : 'warn'
