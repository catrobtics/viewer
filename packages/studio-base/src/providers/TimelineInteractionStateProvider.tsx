...
import type { TimelinePositionedEvent } from '@catrobotics/studio-base/context/EventsContext'
import type {
  SyncBounds,
  TimelineInteractionStateStore,
} from '@catrobotics/studio-base/context/TimelineInteractionStateContext'
import type { HoverValue } from '@catrobotics/studio-base/types/hoverValue'
