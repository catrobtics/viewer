...
import type { MosaicDropTargetPosition } from '@catrobotics/studio-base/types/panels'
...
describe('layout reducers', () => {
  describe('adds panel to a layout', () => {
    ...
    it('adds panel to empty Tab layout', () => {
      ...
      expect((configById['Tab!a'] as TabPanelConfig | undefined)?.activeTabIdx).toEqual(0)
  ...
  describe('panel toolbar actions', () => {
    ...
    it('can split panel inside Tab panel', () => {
      ...
      const { layout, configById } = panels
      expect(layout).toEqual('Tab!a')
      const tabLayout = (configById['Tab!a'] as TabPanelConfig).tabs[0]!.layout! as MosaicParent<string>
    ...
    it('can split inner Tab of two nested Tabs', () => {
      ...
      const { layout, configById } = panels
      expect(layout).toEqual('Tab!a')
      const outerTabLayout = (configById['Tab!a'] as TabPanelConfig).tabs[0]!.layout! as MosaicParent<string>
