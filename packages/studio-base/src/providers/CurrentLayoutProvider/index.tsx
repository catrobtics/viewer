...
import type { PanelConfig, PlaybackConfig, UserScripts } from '@catrobotics/studio-base/types/panels'
...
import CurrentLayoutContext from '@catrobotics/studio-base/context/CurrentLayoutContext'
import panelsReducer from '@catrobotics/studio-base/providers/CurrentLayoutProvider/reducers'
...
export default function CurrentLayoutProvider({
  ...
  const setCurrentLayout = useCallback(
    (newLayout: SelectedLayout | undefined) => {
      const migratedLayout = newLayout?.data == undefined
        ? newLayout
        : { ...newLayout, data: migratePanelsState(newLayout.data) }
      setLayoutState({
        sharedPanelState: {},
