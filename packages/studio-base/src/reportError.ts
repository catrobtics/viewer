...
const globalWithHandler = globalThis as { catroboticsStudioReportErrorFn?: ReportErrorHandler }
...
export function reportError(error: Error): void {
  globalWithHandler.catroboticsStudioReportErrorFn?.(error)
}
...
export function setReportErrorHandler(fn: ReportErrorHandler): void {
  globalWithHandler.catroboticsStudioReportErrorFn = fn
}
