...
import type { NotificationHandler } from '@catrobotics/studio-base/util/sendNotification'

let currentHandler: NotificationHandler | undefined

const mockSendNotification = vi.fn<NotificationHandler>()

function mockSetNotificationHandler(handler?: NotificationHandler): void {
  currentHandler = handler
}

export function expectSendNotificationCalledDuringTest(): void {
