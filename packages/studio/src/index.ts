...
export interface VariableStruct { [key: string]: VariableValue }
...
export interface RenderState {
   ...
   * <https://catrotics.com> for more information.
   */
...
export interface RegisterMessageConverterArgs<Src> {
  fromSchemaName: string
  toSchemaName: string
  converter: (msg: Src, event: Immutable<MessageEvent<Src>>) => unknown
}

interface BaseTopic { name: string, schemaName?: string }
interface TopicAlias { name: string, sourceTopicName: string }
...
export interface SettingsTreeNodeActionItem {
  type: 'action'
...
export interface SettingsTreeNodeActionDivider { type: 'divider' }
